...
<hr class="style1">
<h3 class="header smaller lighter blue"><div align="center"> Hasil Laboratorium </div></h3>
</div>
<table width="100%">
  <tr>
...
<table width="100%" border="1" cellspacing="3" cellpadding="3">
  <tr>
    ...
    <td width="34%"><div align="center"><strong>Hasil</strong></div></td>
    </tr>
  <tbody>
		<?php	
...
<p>&nbsp;</p>
<p>
  <button class="style12" id="tombol" onclick="window.print()" ><i class="icon-print"></i>Print</button>
</p>
</div>
</body>
</html>