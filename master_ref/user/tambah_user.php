...
*/
?>
<?php $foto = 'master_ref/user/img_user/profile-icon.png'; ?>
		...
		<div class="row-fluid">
			<div class="span5">
				<div class="control-group">
					...
					<div class="controls">
						<input class="form-control input-mask-nip" name="nip" type="text" id="form-field-mask-2" name="nip" required autofocus  />
					</div>
				</div>
				<div class="control-group">
...
$("#multi-post").click(function(){
	if(document.multiform.nip.value==""){
		alert("Silahkan Isi nip !");
		document.multiform.nip.focus();
		return false;
		}
